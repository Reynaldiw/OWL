...
class OnboardingViewController: UIViewController {
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pc.currentPageIndicatorTintColor = UIColor.rgb(red: 16, green: 120, blue: 149, alpha: 1)
        pc.pageIndicatorTintColor = UIColor.rgb(red: 228, green: 228, blue: 228, alpha: 1)
        return pc
    }()
    ...
    @objc func handleNext() {
     ...
     func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        if pageControl.currentPage == pages.count-1 {
            ...
            nextButton.setTitleColor(UIColor.rgb(red: 16, green: 120, blue: 149, alpha: 1), for: .normal)
        }

    }
    
    @objc func gotoLastPage() {
        print("change")
        nextButton.setTitle("Get Started", for: .normal)
        nextButton.backgroundColor = UIColor.rgb(red: 16, green: 120, blue: 149, alpha: 1)
    ...
    @objc func gotoSignup() {
        ...
        navController.viewControllers = [LoginScreen()]
