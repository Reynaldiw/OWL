//
//  HeaderCategoryLearnReusableView.swift
//  owl
//
...
class HeaderCategoryLearnReusableView: UICollectionReusableView {
    ...
    func setupStackViewConstraint() {
        stackView.anchor(top: topAnchor, bottom: bottomAnchor, leading: leadingAnchor, trailing: trailingAnchor, marginTop: 10, marginBottom: -10, marginLeading: 30, marginTrailing: 30, width: 0, height: 0, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
    }
